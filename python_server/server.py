...
from voronoi_handlers import get_clipped_voronoi, generate_recursive_voronoi
...
@app.post("/RecursiveVoronoi")
async def get_recursive_voronoi_(data: RecursiveVoronoiData):
    return generate_recursive_voronoi(data.polygon, data.n, data.d, data.seed, data.round_corner, erode=data.erode)
